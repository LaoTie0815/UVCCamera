...
package com.laotie.usbcameracommon;
...
import com.laotie.encoder.MediaAudioEncoder;
import com.laotie.encoder.MediaEncoder;
import com.laotie.encoder.MediaMuxerWrapper;
import com.laotie.encoder.MediaSurfaceEncoder;
import com.laotie.encoder.MediaVideoBufferEncoder;
import com.laotie.encoder.MediaVideoEncoder;
import com.laotie.uvccamera.IFrameCallback;
import com.laotie.uvccamera.USBMonitor;
import com.laotie.uvccamera.UVCCamera;
...
abstract class AbstractUVCCameraHandler extends Handler {
	...
	static final class CameraThread extends Thread {
		...
		public void handleStartRecording() {
			...
			try {
				...
				if (videoEncoder != null) {
					mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_NV21, false);
				}
				synchronized (mSync) {
					mMuxer = muxer;
		...
		public void handleStopRecording() {
			...
			if (muxer != null) {
				muxer.stopRecording();
				mUVCCamera.setFrameCallback(null, 0, false);
		...
		private final IFrameCallback mIFrameCallback = new IFrameCallback() {
			@Override
			public void onVerifyFrame(ByteBuffer frame, ByteBuffer verifyResultBuffer) {
