...
// カメラとの接続を解除
static jint nativeRelease(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
//======================================================================
static jint nativeSetStatusCallback(JNIEnv *env, jclass thiz,
...
static jint nativeSetButtonCallback(JNIEnv *env, jclass thiz,
...
static jstring nativeGetSupportedSize(JNIEnv *env, jclass thiz, ID_TYPE id_camera) {

    ENTER();
    LOGE("nativeGetSupportedSize");
    jstring result = NULL;
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
        char *c_str = camera->getSupportedSize();
//        char *c_str = "{\"formats\":[{\"index\":1,\"type\":4,\"default\":1,\"size\":[\"960x540\"]},{\"index\":2,\"type\":6,\"default\":1,\"size\":[\"960x540\",\"1280x720\",\"1920x1080\"]},{}]}";
        LOGE("c_str:%s", c_str);
        if (LIKELY(c_str)) {
...
//======================================================================
// プレビュー画面の大きさをセット
static jint nativeSetPreviewSize(JNIEnv *env, jclass thiz,
...
static jint nativeStartPreview(JNIEnv *env, jclass thiz,
                               ID_TYPE id_camera) {
...
// プレビューを停止
static jint nativeStopPreview(JNIEnv *env, jclass thiz, ID_TYPE id_camera) {

    LOGE("nativeStopPreview");
    jint result = JNI_ERR;
    ENTER();
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetPreviewDisplay(JNIEnv *env, jclass thiz, ID_TYPE id_camera, jobject jSurface) {
    jint result = JNI_ERR;
    ENTER();
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetFrameCallback(JNIEnv *env, jclass thiz,
                                   ID_TYPE id_camera, jobject jIFrameCallback, jint pixel_format, jboolean isNeedFrameCallback) {
    ...
    if (LIKELY(camera)) {
        ...
        result = camera->setFrameCallback(env, frame_callback_obj, pixel_format, isNeedFrameCallback);
    }
    RETURN(result, jint);
}

static jint nativeSetCaptureDisplay(JNIEnv *env, jclass thiz,
...
static jlong nativeGetCtrlSupports(JNIEnv *env, jclass thiz,
                                   ID_TYPE id_camera) {
...
static jlong nativeGetProcSupports(JNIEnv *env, jclass thiz,
                                   ID_TYPE id_camera) {
...
static jint nativeSetScanningMode(JNIEnv *env, jclass thiz,
...
static jint nativeGetScanningMode(JNIEnv *env, jclass thiz,
                                  ID_TYPE id_camera) {
...
static jint nativeSetExposureMode(JNIEnv *env, jclass thiz,
...
static jint nativeGetExposureMode(JNIEnv *env, jclass thiz,
                                  ID_TYPE id_camera) {
...
static jint nativeSetExposurePriority(JNIEnv *env, jclass thiz,
...
static jint nativeGetExposurePriority(JNIEnv *env, jclass thiz,
                                      ID_TYPE id_camera) {
...
static jint nativeSetExposure(JNIEnv *env, jclass thiz,
...
static jint nativeGetExposure(JNIEnv *env, jclass thiz,
                              ID_TYPE id_camera) {
...
static jint nativeSetExposureRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetExposureRel(JNIEnv *env, jclass thiz,
                                 ID_TYPE id_camera) {
...
static jint nativeSetAutoFocus(JNIEnv *env, jclass thiz,
...
static jint nativeGetAutoFocus(JNIEnv *env, jclass thiz,
                               ID_TYPE id_camera) {
...
static jint nativeSetAutoWhiteBlance(JNIEnv *env, jclass thiz,
                                     ID_TYPE id_camera, jboolean autofocus) {
...
static jint nativeGetAutoWhiteBlance(JNIEnv *env, jclass thiz,
                                     ID_TYPE id_camera) {
...
static jint nativeSetAutoWhiteBlanceCompo(JNIEnv *env, jclass thiz,
...
static jint nativeGetAutoWhiteBlanceCompo(JNIEnv *env, jclass thiz,
                                          ID_TYPE id_camera) {
...
static jint nativeSetBrightness(JNIEnv *env, jclass thiz,
...
static jint nativeGetBrightness(JNIEnv *env, jclass thiz,
                                ID_TYPE id_camera) {
...
static jint nativeSetFocus(JNIEnv *env, jclass thiz,
...
static jint nativeGetFocus(JNIEnv *env, jclass thiz,
                           ID_TYPE id_camera) {
...
static jint nativeSetFocusRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetFocusRel(JNIEnv *env, jclass thiz,
                              ID_TYPE id_camera) {
...
static jint nativeSetIris(JNIEnv *env, jclass thiz,
...
static jint nativeGetIris(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
static jint nativeSetIrisRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetIrisRel(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
static jint nativeSetPan(JNIEnv *env, jclass thiz,
...
static jint nativeGetPan(JNIEnv *env, jclass thiz,
                         ID_TYPE id_camera) {
...
static jint nativeSetTilt(JNIEnv *env, jclass thiz,
...
static jint nativeGetTilt(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
static jint nativeSetRoll(JNIEnv *env, jclass thiz,
...
static jint nativeGetRoll(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
static jint nativeSetPanRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetPanRel(JNIEnv *env, jclass thiz,
                            ID_TYPE id_camera) {
...
static jint nativeSetTiltRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetTiltRel(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
static jint nativeSetRollRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetRollRel(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
static jint nativeSetContrast(JNIEnv *env, jclass thiz,
...
static jint nativeGetContrast(JNIEnv *env, jclass thiz,
                              ID_TYPE id_camera) {
...
static jint nativeSetAutoContrast(JNIEnv *env, jclass thiz,
...
static jint nativeGetAutoContrast(JNIEnv *env, jclass thiz,
                                  ID_TYPE id_camera) {
...
static jint nativeSetSharpness(JNIEnv *env, jclass thiz,
...
static jint nativeGetSharpness(JNIEnv *env, jclass thiz,
                               ID_TYPE id_camera) {
...
static jint nativeSetGain(JNIEnv *env, jclass thiz,
...
static jint nativeGetGain(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
static jint nativeSetGamma(JNIEnv *env, jclass thiz,
...
static jint nativeGetGamma(JNIEnv *env, jclass thiz,
                           ID_TYPE id_camera) {
...
static jint nativeSetWhiteBlance(JNIEnv *env, jclass thiz,
...
static jint nativeGetWhiteBlance(JNIEnv *env, jclass thiz,
                                 ID_TYPE id_camera) {
...
static jint nativeSetWhiteBlanceCompo(JNIEnv *env, jclass thiz,
...
static jint nativeGetWhiteBlanceCompo(JNIEnv *env, jclass thiz,
                                      ID_TYPE id_camera) {
...
static jint nativeSetBacklightComp(JNIEnv *env, jclass thiz,
...
static jint nativeGetBacklightComp(JNIEnv *env, jclass thiz,
                                   ID_TYPE id_camera) {
...
static jint nativeSetSaturation(JNIEnv *env, jclass thiz,
...
static jint nativeGetSaturation(JNIEnv *env, jclass thiz,
                                ID_TYPE id_camera) {
...
static jint nativeSetHue(JNIEnv *env, jclass thiz,
...
static jint nativeGetHue(JNIEnv *env, jclass thiz,
                         ID_TYPE id_camera) {
...
static jint nativeSetAutoHue(JNIEnv *env, jclass thiz,
...
static jint nativeGetAutoHue(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
static jint nativeSetPowerlineFrequency(JNIEnv *env, jclass thiz,
...
static jint nativeGetPowerlineFrequency(JNIEnv *env, jclass thiz,
                                        ID_TYPE id_camera) {
...
static jint nativeSetZoom(JNIEnv *env, jclass thiz,
...
static jint nativeGetZoom(JNIEnv *env, jclass thiz,
                          ID_TYPE id_camera) {
...
static jint nativeSetZoomRel(JNIEnv *env, jclass thiz,
...
static jint nativeGetZoomRel(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
static jint nativeSetDigitalMultiplier(JNIEnv *env, jclass thiz,
...
static jint nativeGetDigitalMultiplier(JNIEnv *env, jclass thiz,
                                       ID_TYPE id_camera) {
...
static jint nativeSetDigitalMultiplierLimit(JNIEnv *env, jclass thiz,
...
static jint nativeGetDigitalMultiplierLimit(JNIEnv *env, jclass thiz,
                                            ID_TYPE id_camera) {
...
static jint nativeSetAnalogVideoStandard(JNIEnv *env, jclass thiz,
...
static jint nativeGetAnalogVideoStandard(JNIEnv *env, jclass thiz,
                                         ID_TYPE id_camera) {
...
static jint nativeSetAnalogVideoLockState(JNIEnv *env, jclass thiz,
...
static jint nativeGetAnalogVideoLockState(JNIEnv *env, jclass thiz,
                                          ID_TYPE id_camera) {
...
static jint nativeSetPrivacy(JNIEnv *env, jclass thiz,
...
static jint nativeGetPrivacy(JNIEnv *env, jclass thiz,
                             ID_TYPE id_camera) {
...
jint registerNativeMethods(JNIEnv *env) {
    ...
    JNINativeMethod gNativeAPIMethods[] = {
            ...
            {"nativeSetStatusCallback",                 "(JLcom/laotie/uvccamera/IStatusCallback;)I",  (void *) nativeSetStatusCallback},
            {"nativeSetButtonCallback",                 "(JLcom/laotie/uvccamera/IButtonCallback;)I",  (void *) nativeSetButtonCallback},
            ...
            {"nativeSetFrameCallback",                  "(JLcom/laotie/uvccamera/IFrameCallback;IZ)I", (void *) nativeSetFrameCallback},
...
//	{ "nativeGetFocusSimple",			"(J)I", (void *) nativeGetFocusSimple },
    ...
    jclass chunk_class = env->FindClass("com/laotie/uvccamera/UVCCamera");
    if (!chunk_class) {
        return JNI_ERR;
    }
